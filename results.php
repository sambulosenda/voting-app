		...
		<div class="row margin-bot60">
			...
			<div class="col-md-4">
				...
				<div class="results-box-txt pull-left text-left">
					...
					<p class="results-pres-name"><?php echo $info[0]["name"] ?></p>
					<p class="results-mov-name">"<?php echo $info[0]["movie"] ?>"</p>
					<h2 class="pull-left margin-top10"><span id="bav" class="counter"><?php echo $total0 ?></span>%</h2>
				</div>
			</div>
			<div class="col-md-4">
			</div>
		...
		<div class="row margin-bot60">
			...
			<div class="col-md-4">
				...
				<div class="results-box-txt pull-left text-left">
					...
					<p class="results-pres-name"><?php echo $info[1]["name"] ?></p>
					<p class="results-mov-name">"<?php echo $info[1]["movie"] ?>"</p>
					<h2 class="pull-left margin-top10"><span id="tbv" class="counter"><?php echo $total1 ?></span>%</h2>
				</div>
			</div>
			<div class="col-md-4">
				<div class="results-box-img pull-left">
				...
				<div class="results-box-txt pull-left text-left">
					...
					<h2 class="pull-left margin-top10"><span id="asv" class="counter"><?php echo $total2 ?></span>%</h2>
				</div>
			</div>
			<div class="col-md-2">
			</div>
		...
		<div class="row margin-bot60">
			<div class="col-md-4">
				...
				<div class="results-box-txt pull-left text-left">
					...
					<p class="results-pres-name"><?php echo $info[3]["name"] ?></p>
					<p class="results-mov-name">"<?php echo $info[3]["movie"] ?>"</p>
					<h2 class="pull-left margin-top10"><span id="pcv" class="counter"><?php echo $total3 ?></span>%</h2>
				</div>
			</div>
			<div class="col-md-4">
			...
			<div class="col-md-4">
				...
				<div class="results-box-txt pull-left text-left">
					...
					<p class="results-pres-name"><?php echo $info[4]["name"] ?></p>
					<p class="results-mov-name">"<?php echo $info[4]["movie"] ?>"</p>
					<h2 class="pull-left margin-top10"><span id="twv" class="counter"><?php echo $total4 ?></span>%</h2>
				</div>
			</div>
		</div>
		...
		<div class="row margin-bot60">
			...
			<div class="col-md-4">
				...
				<div class="results-box-txt pull-left text-left">
					...
					<p class="results-pres-name"><?php echo $info[5]["name"] ?></p>
					<p class="results-mov-name">"<?php echo $info[5]["movie"] ?>"</p>
					<h2 class="pull-left margin-top10"><span id="jbv" class="counter"><?php echo $total5 ?></span>%</h2>
				</div>
			</div>
			<div class="col-md-2">
			</div>
			<div class="col-md-4">
				...
				<div class="results-box-txt pull-left text-left">
					...
					<p class="results-pres-name"><?php echo $info[6]["name"] ?></p>
					<p class="results-mov-name">"<?php echo $info[6]["movie"] ?>"</p>
					<h2 class="pull-left margin-top10"><span id="jdv" class="counter"><?php echo $total6 ?></span>%</h2>
				</div>
			</div>
		</div>
		...
		<div class="row margin-bot60">
			...
			<div class="col-md-4">
				...
				<div class="results-box-txt pull-left text-left">
					...
					<p class="results-pres-name"><?php echo $info[7]["name"] ?></p>
					<p class="results-mov-name">"<?php echo $info[7]["movie"] ?>"</p>
					<h2 class="pull-left margin-top10"><span id="plv" class="counter"><?php echo $total7 ?></span>%</h2>
				</div>
			</div>
			<div class="col-md-4">
				<div class="results-box-img pull-left">
				...
				<div class="results-box-txt pull-left text-left">
					...
					<p class="results-pres-name"><?php echo $info[8]["name"] ?></p>
					<p class="results-mov-name">"<?php echo $info[8]["movie"] ?>"</p>
					<h2 class="pull-left margin-top10"><span id="jmv" class="counter"><?php echo $total8 ?></span>%</h2>
				</div>
			</div>
			<div class="col-md-2">
			</div>
